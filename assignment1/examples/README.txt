...
file.
3. After this, we have to export this shared library for dynamic linking to the folder and set the
environment variable in which examples file are present by providing a path to the shared library. 

Run these following commands back to back:-
